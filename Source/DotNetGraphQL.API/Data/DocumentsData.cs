...
namespace DotNetGraphQL.API
{
    ...
    {
        readonly static Lazy<IEnumerable<Document>> _docHolder = new Lazy<IEnumerable<Document>>(CreateDogImageList);

        public static IEnumerable<Document> DocuSamples => _docHolder.Value;

        static IEnumerable<Document> CreateDogImageList()
        {
        ...
        static Document GenerateKirbyModel()
        {
            ...
            return new Document(avatarUrl, websiteUrl, name, photosList, breed, coatColor, birthDate);
        }

        static Document GenerateWafflesModel()
        {
        ...
        static Document GenerateWhiskeyModel()
        {
        ...
        static Document GenerateTobyModel()
        {
        ...
        static Document GenerateMozzieModel()
        {
        ...
        static Document GeneratePiperModel()
        {
            ...
            return new Document(avatarUrl, websiteUrl, name, photosList, breed, coatColor, DateTime.Now);
        }

        static Document GenerateMiloModel()
        {
            ...
            return new Document(avatarUrl, websiteUrl, name, photosList, breed, coatColor);
        }

        static Document GenerateMagicModel()
        {
        ...
        static Document GenerateHermesModel()
        {
